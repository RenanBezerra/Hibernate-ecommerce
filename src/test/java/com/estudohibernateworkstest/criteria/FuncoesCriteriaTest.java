...
public class FuncoesCriteriaTest extends EntityManagerTest {
	...
	public void aplicarFuncaoString() {
		...
		criteriaQuery.multiselect(root.get(Cliente_.nome),
				...
				criteriaBuilder.length(root.get(Cliente_.nome)), criteriaBuilder.locate(root.get(Cliente_.nome), "a"),
				criteriaBuilder.substring(root.get(Cliente_.nome), 1, 2),
				criteriaBuilder.lower(root.get(Cliente_.nome)), criteriaBuilder.upper(root.get(Cliente_.nome)),
